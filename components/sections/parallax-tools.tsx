...
const tools: ToolItem[] = [
  ...
  { name: "Instantly.ai", speed: 0.12, opacity: 1.0, fontSize: "2.4rem", top: "58%", left: "82%", link: "https://instantly.ai/?via=muhammad-nouman", logoSrc: "/affiliate-logos/instantly.png" },
